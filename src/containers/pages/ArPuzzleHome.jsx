        ...
        <div className="relative mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="py-12 grid grid-cols-1 md:grid-cols-2 justify-items-center items-center gap-6 md:gap-0">
            <div>
              <p className="text-lg text-white block">
                ...
                <br></br>
                "Augmented Reality" Puzzle es un videojuego pensado para acercar
                la realidad aumentada a todo el mundo. A través de nuestro
                teléfono móvil escanearemos códigos QR para traer elementos del
                mundo virtual a nuestro mundo real.
                <br></br>
                <br></br>
          ...
          <div class="relative py-10">
            ...
            <div class="relative flex justify-center">
              <span class="bg-gray-400 px-3 text-gray-500"></span>
            </div>
          </div>
          ...
          <div className="py-12 grid grid-cols-1 md:grid-cols-2 justify-items-center items-center gap-6 md:gap-0">
            <div>
              <p className="text-lg text-white block">
                ...
                vez escaneado será como si el puzzle apareciera de verdad
                delante de ti.
                <br></br>
                <br></br>
