...
function Descarga() {
  useEffect(() => {
    ...
    document.title = "Descarga | AR Puzzle";
  }, []);
        ...
        <div className="pt-12 grid grid-cols-1 lg:grid-cols-2 justify-items-center items-center gap-6 lg:gap-0">
          <div>
            <p className="text-lg text-center lg:text-left text-white block">
              ...
              <br></br>
              Estamos muy agradecidos de que quieras probar nuestro juego. Para
              empezar a jugar, descarga el juego en tu dispositivo móvil y
              podrás empezar a jugar y a crear tus propios puzzles.
              <br></br>
              <br></br>
        ...
        <div className="pt-12 pb-28 grid grid-cols-1 lg:grid-cols-2 justify-items-center items-center gap-6 lg:gap-0">
          <div>
            <p className="text-lg text-center text-white block">
              ...
              <br></br>
              Esto descargará un archivo pdf que podrás imprimir y recortar para
              tener las tarjetas del mapa y las herramientas.
              <br></br>
              <br></br>
